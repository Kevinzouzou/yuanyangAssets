...
function getCostTemplate(id){
	...
	$.ajax({
		type:'post',
		url:'http://127.0.0.1:8080/yuanyang/housMeter/page',
...
function findOneTemplate(sCode){
	$.ajax({
		type : "post",
		url :"http://127.0.0.1:8080/yuanyang/housMeter/findOne",
		dataType: 'jsonp',
		data :{sCode:sCode},
		success : function(data) {
...
$("#addOwnerModal .btn_sure").click(function(){
	...
	$.ajax({
		type : "post",
		url :"http://127.0.0.1:8080/yuanyang/housMeter/add",
		dataType: 'jsonp',
...
$("#editOwnerModal .btn_sure").click(function(){
	...
	$.ajax({
		type : "post",
		url :"http://127.0.0.1:8080/yuanyang/housMeter/edit",
		data :{sCode:sCode,
...
$("#delOwnerModal .btn_sure").click(function(){
	...
	$.ajax({
		type : "post",
		url :"http://127.0.0.1:8080/yuanyang/housMeter/delAll",
...
$("#tab_cost_template .btn_modify").click(function(){
	...
	$.ajax({
		type:'post',
		url:'http://127.0.0.1:8080/yuanyang/housMeter/findPrice',
		data:{sBuildName:sBuildName,sEnergyType:sEnergyType},
		success:function(data) {
...
$("#editPriceModal .btn_sure").click(function(){
	...
	$.ajax({
		type:'post',
		url:'http://127.0.0.1:8080/yuanyang/housMeter/editAll',
...
$("#leadInOwnerModal .btn_sure").click(function(){
	...
	oReq.open("POST", "http://127.0.0.1:8080/yuanyang/housMeter/upExcel", true);
...
$("#leadOutOwnerModal").click(function(){
	...
	$.ajax({
		type:'post',
		url:'http://127.0.0.1:8080/yuanyang/housMeter/exportExcel',
		data:{sBuildName:sBuildName,sEnergyType:sEnergyType},
		success:function(data) {
...
function getmatervalue(id,sEnergyType){
	...
	$.ajax({
		type:'post',
		url:'http://127.0.0.1:8080/yuanyang/meterRead/page',
...
$("#addGassMeterModal .btn_sure").click(function(){
	...
	$.ajax({
		type : "post",
		url :"http://127.0.0.1:8080/yuanyang/meterRead/add",
		data :{sBuildName:sBuildName,
			sMeterCode:sMeterCode,
			sMeterPos:sMeterPos,
			sEnergyType:sEnergyType,
...
$("#delGassMeterModal .btn_sure").click(function(){
	...
	$.ajax({
		type : "post",
		url :"http://127.0.0.1:8080/yuanyang/meterRead/del",
		data :{sCode:sCode},
		success : function(data) {
			getgassmatervalue();
		}
...
function editGassMeter(sCode){
	$.ajax({
		type : "post",
		url :"http://127.0.0.1:8080/yuanyang/meterRead/findOne",
		data :{sCode:sCode},
		success : function(data) {
...
$("#deitGassMeterModal .btn_sure").click(function(){
	...
	$.ajax({
		type : "post",
		url :"http://127.0.0.1:8080/yuanyang/meterRead/edit",
		data :{sBuildName:sBuildName,
			sMeterCode:sMeterCode,
			sMeterPos:sMeterPos,
			sEnergyType:sEnergyType,
...
$("#leadInWaterMeterModal .btn_sure").click(function(){
	...
	//创建一个XMLHttpRequest()
	var oReq = new XMLHttpRequest();
	oReq.open("POST", "http://127.0.0.1:8080/yuanyang/meterRead/upExcel", true);
	oReq.onload = function(oEvent) {
		if (oReq.status == 200) {
...
function getBuildinginfo(id,sBuildName){
	$.ajax({
		type:'post',
		url:'http://127.0.0.1:8080/yuanyang/build/findOne',
		data:{sBuildName:sBuildName},
		success:function(data) {
			console.log(JSON.stringify(data)+"------");
...
$("#addBuildInfoModal .btn_sure").click(function(){
	...
	$.ajax({
		type : "post",
		url :"http://127.0.0.1:8080/yuanyang/build/add",
		data :{sBuildName:sBuildName,
...
$("#editBuildInfoModal .btn_sure").click(function(){
	...
	$.ajax({
		type : "post",
		url :"http://127.0.0.1:8080/yuanyang/build/edit",
...
$("#delBuildInModal .btn_sure").click(function(){
	...
	$.ajax({
		type : "post",
		url :"http://127.0.0.1:8080/yuanyang/housMater/delAll",
		data :{sBuildCode:sBuildCode},
		success : function(data) {
			buildinginfo(sBuildName);
		}
